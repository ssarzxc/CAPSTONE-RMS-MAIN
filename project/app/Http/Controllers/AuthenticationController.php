...
class AuthenticationController extends Controller
{
    ...
    {
        return view('st-guest.login');
    }

    public function showRegisterForm()
    {
        return view('st-guest.register');
    }
    ...
    public function register(Request $request)
    {
        ...
        return redirect()->route('st-guest.dashboard')->with('success', 'Registration successful!');
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('guest')->attempt($credentials)) {
            ...
            return redirect()->route('st-guest.dashboard');
        }
    ...
    public function logout()
    {
        ...
        return redirect()->route('st-guest.login');
    }
}
