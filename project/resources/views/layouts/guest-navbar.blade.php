    ...
    <header x-data="{ mobilenavOpen: false }"
        ...
        <div x-show="mobilenavOpen" x-cloak
            ...
            <ul class="flex flex-col items-start space-y-2 p-4">
                <li><a href="" class="block w-full py-2 hover:bg-green-700 px-4">Dashboard</a></li>
                <li><a href="" class="block w-full py-2 hover:bg-green-700 px-4">Reservations</a></li>
                <li><a href="" class="block w-full py-2 hover:bg-green-700 px-4">Rooms</a></li>
                <li><a href="" class="block w-full py-2 hover:bg-green-700 px-4">Settings</a></li>
