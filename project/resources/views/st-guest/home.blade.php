...
<body class="flex flex-col min-h-screen">
    @section('content')
        <main class="flex-grow">
            <div class="grid w-full h-screen bg-gray-700 text-white text-center bg-center bg-cover"
                ...
                <div class="col-start-1 row-start-1 py-24 px-10 flex flex-col items-center justify-center">
                    ...
                    <p class=" drop-shadow-[2px_2px_4px_rgba(0,0,0,0.8)] text-lg font-bold mb-5 mt-4">where nature meets
                        elegance
                    </p>
                            ...
                            <div class="flex transition-transform duration-700"
                                ...
                                <div class="flex min-w-full justify-center space-x-4">
                                    ...
                                    <div
                                        ...
                                        <img src="{{ asset('images/canopyhome.png') }}"
                                            class="w-full h-[300px] object-cover" alt="Service 1">
                                        <div class="p-4 flex-grow flex flex-col">
                                            <h5 class="text-lg text-center font-semibold">Canopy Home 1</h5>
                                            <p class="text-sm text-center text-gray-600 flex-grow">Experience the ultimate
                                                comfort
                                                in our canopy
                                                home.</p>
                                    ...
                                    <div
                                        class="w-1/3 bg-white border border-gray-200 rounded-lg overflow-hidden flex flex-col h-[450px]">
                                        <img src="{{ asset('images/canopypool.png') }}"
                                            class="w-full h-[300px] object-cover" alt="Service 2">
                                        <div class="p-4 flex-grow flex flex-col">
                                            <h5 class="text-lg text-center font-semibold">Lakeview Resort 2</h5>
                                            <p class="text-sm text-center text-gray-600 flex-grow">Enjoy stunning lake views
                                                and
                                                relax in
                                                nature.</p>
                                    ...
                                    <div
                                        ...
                                        <div class="p-4 flex-grow flex flex-col">
                                            ...
                                            <p class="text-sm text-center text-gray-600 flex-grow">Thrilling rides and
                                                exciting
                                                experiences
                                                await.</p>
                                            <div class="mt-auto text-center">
